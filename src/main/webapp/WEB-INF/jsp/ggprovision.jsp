<%-- 
    Document   : ggprovision
    Created on : Sep 7, 2022, 8:06:32 PM
...
<div>
    ...
    <br>
    <span><a href="<c:url value="/registerggshipper"/>">Đăng ký shipper</a></span>
    <span><a href="<c:url value="/registerggcustomer"/>">Đăng ký Customer</a></span>
</div>
