...
<form method="post" action="${action}">
    ...
    <div class="form-group"> 
        ...
        <div style="margin-bottom: 5px;border:1px solid graytext; text-align: center">      
            ...
            <span><a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/nshipwebsite/provision&response_type=code&client_id=990893174800-qnfnmksq5h18ul4qo916d04rml9jqi94.apps.googleusercontent.com&approval_prompt=force">LOG IN WITH GOOGLE</a></span>
        </div>
